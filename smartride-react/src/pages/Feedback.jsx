        ...
        <div className="row justify-content-center">
          <div className="col-md-6">
            <div className="bg-light p-4 rounded shadow-sm animate__animated animate__fadeInUp">
              ...
              {/* Star Rating */}
              <div className="star-rating mb-3 text-center" style={{ fontSize: "2rem" }}>
                {[1, 2, 3, 4, 5].map((star) => (
                  <i
                    key={star}
                    className={`fas fa-star star ${star <= (hovered || rating) ? "selected" : ""}`}
                    style={{ color: star <= (hovered || rating) ? "gold" : "#ccc", cursor: "pointer" }}
